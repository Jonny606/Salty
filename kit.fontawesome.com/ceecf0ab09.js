...
! function(t) {
            ...
            if (null != n) {
                ...
                try {
                    if (a = (n = n.call(t)).next, 0 === e) {
                        ...
                        for (; !(s = (o = a.call(n)).done) && (c.push(o.value), c.length !== e); s = !0);
                } catch (t) {
                    f = !0, r = t
                } finally {
                    try {
    ...
    var c, s, f, l, u, d = "thumbprint",
        h = (o(c = {}, "classic", "Classic"), o(c, "duotone", "Duotone"), o(c, "sharp", "Sharp"), o(c, "sharp-duotone", "Sharp Duotone"), o(c, "chisel", "Chisel"), o(c, "etch", "Etch"), o(c, "jelly", "Jelly"), o(c, "jelly-duo", "Jelly Duo"), o(c, "jelly-fill", "Jelly Fill"), o(c, "notdog", "Notdog"), o(c, "notdog-duo", "Notdog Duo"), o(c, "slab", "Slab"), o(c, "slab-press", "Slab Press"), o(c, "thumbprint", "Thumbprint"), o(c, "whiteboard", "Whiteboard"), ["fak", "fa-kit", "fakd", "fa-kit-duotone"]),
        p = (o(s = {}, "kit", "Kit"), o(s, "kit-duotone", "Kit Duotone"), "duotone-group"),
        m = "swap-opacity",
        b = "primary",
        y = "secondary",
        v = (o(f = {}, "classic", "Classic"), o(f, "duotone", "Duotone"), o(f, "sharp", "Sharp"), o(f, "sharp-duotone", "Sharp Duotone"), o(f, "chisel", "Chisel"), o(f, "etch", "Etch"), o(f, "jelly", "Jelly"), o(f, "jelly-duo", "Jelly Duo"), o(f, "jelly-fill", "Jelly Fill"), o(f, "notdog", "Notdog"), o(f, "notdog-duo", "Notdog Duo"), o(f, "slab", "Slab"), o(f, "slab-press", "Slab Press"), o(f, "thumbprint", "Thumbprint"), o(f, "whiteboard", "Whiteboard"), o(l = {}, "kit", "Kit"), o(l, "kit-duotone", "Kit Duotone"), ["fa", "fas", "far", "fal", "fat", "fad", "fadr", "fadl", "fadt", "fab", "fass", "fasr", "fasl", "fast", "fasds", "fasdr", "fasdl", "fasdt", "faslr", "faslpr", "fawsb", "fatl", "fans", "fands", "faes", "fajr", "fajfr", "fajdr", "facr"].concat(["fa-classic", "fa-duotone", "fa-sharp", "fa-sharp-duotone", "fa-thumbprint", "fa-whiteboard", "fa-notdog", "fa-notdog-duo", "fa-chisel", "fa-etch", "fa-jelly", "fa-jelly-fill", "fa-jelly-duo", "fa-slab", "fa-slab-press"], ["fa-solid", "fa-regular", "fa-light", "fa-thin", "fa-duotone", "fa-brands", "fa-semibold"])),
    ...
    function C(t) {
        ...
        x(a, o) || ("fulfilled" === n && I(a, o), "rejected" === n && D(a, o))
    }
    ...
    function N(t) {
        t._state = "rejected", U(t), !t._handled && E && global.process.emit("unhandledRejection", t._data, t)
    }
    ...
    M.prototype = {
        ...
        return new M((function(e, n) {
            ...
            for (var i, c = 0; c < t.length; c++)(i = t[c]) && "function" == typeof i.then ? i.then(a(c), n) : o[c] = i;
            r || e(o)
        }))
    }, M.race = function(t) {
    ...
    function J(t, e) {
        ...
        }(t) && ("URLSearchParams" in window ? (a = new URL(t)).searchParams.set("token", r) : a = a + "?token=" + encodeURIComponent(r)), a = a.toString(), new R((function(t, e) {
            if ("function" == typeof n) n(a, {
                mode: "cors",
                cache: "default"
            }).then((function(t) {
    ...
    function Y(t) {
        var e, n = [],
            ...
            a = (r ? /^loaded|^c/ : /^loaded|^i|^c/).test(o.readyState);
        a || o.addEventListener("DOMContentLoaded", e = function() {
            for (o.removeEventListener("DOMContentLoaded", e), a = 1; e = n.shift();) e()
